...
plt.tight_layout()
plt.savefig(os.path.join(save_dir, "combined_top_gdp_summary.png"), bbox_inches='tight', dpi=300)
plt.show()  
...
plt.tight_layout()
plt.savefig(os.path.join(save_dir, "combined_top_gdp_bar.png"), bbox_inches='tight', dpi=300)
